...
def get_env_float(env_name, default=0.0):
    try:
...
def main():
    ...
    panel_length = get_env_float('panel_length')
    panel_width = get_env_float('panel_width')
    entire_slab_depth = get_env_float('entire_slab_depth')
    slab_thickness = get_env_float('slab_thickness')
    ...
    void_mould_length = get_env_float('void_mould_length')
    void_mould_width = get_env_float('void_mould_width')
    volume_of_void_in_one_mould = get_env_float('volume_of_void_in_one_mould')
    bottom_length_of_rib = get_env_float('bottom_length_of_rib')
    top_length_of_rib = get_env_float('top_length_of_rib')
    ...
    dead_load_constant = get_env_float('dead_load_constant')
    live_load_constant = get_env_float('live_load_constant')

    dead_load = 24.0 * net_void_volume * dead_load_constant
    finishes_value = get_env_float('finishes_value')
    finishes = finishes_value * panel_length * panel_width * dead_load_constant
    live_load_value = get_env_float('live_load_value')
    ...
    negative_moment_at_continuous_edge = get_env_float('negative_moment_at_continuous_edge')
    positive_moment_at_mid_span = get_env_float('positive_moment_at_mid_span')

    print('\nDesigning for Span:')
    span_moment = unit_load_per_rib * panel_width ** 2 * positive_moment_at_mid_span
    print('Moment = ', span_moment, 'KNm per rib')

    steel_strength = get_env_float('steel_strength')
    stirrup_diameter = get_env_float('stirrup_diameter')
    cover_length = get_env_float('cover_length')
    fcu_value = get_env_float('fcu_value')
    ...
    preferred_reinforcement_size = get_env_float('preferred_reinforcement_size')
    ...
    preferred_support_reinforcement_size = get_env_float('preferred_support_reinforcement_size')
    ...
    bar_spacing = get_env_float('bar_spacing')
    ...
    shear_coefficient = get_env_float('shear_coefficient')
